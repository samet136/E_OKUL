...
WHERE  (Tbl_Ogrenciler.OgrenciAd = @OgrenciAd)";
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "INSERT INTO Tbl_Ogrenciler\r\n                  ( OgrenciAd , OgrenciSoyad, Ogrenci" +
                "Kulup, Ogrencicinsiyet)\r\nVALUES  (@OgrenciAd,@OgrenciSoyad,@OgrenciKulup,@Ogrenc" +
                "icinsiyet)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int OgrenciGuncelleme(string OgrenciAd, string OgrenciSoyad, global::System.Nullable<byte> OgrenciKulup, string Ogrencicinsiyet, int OgrenciId) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((OgrenciAd == null)) {
                command.Parameters[0].Value = global::System.DBNull.Value;
            }
...
SELECT NotId, DersId, OgrenciId, Sinav1, Sinav2, Sinav3, Proje, Ortalama, Durum FROM Tbl_Notlar WHERE (NotId = @NotId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "UPDATE  Tbl_Notlar SET  DersId = @DersId, OgrenciId = @OgrenciId, Sinav1 = @Sinav" +
                "1, Sinav2 = @Sinav2, Sinav3 = @Sinav3, Proje = @Proje, Ortalama = @Ortalama, Dur" +
                "um = @Durum WHERE NotId = @NotId ";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        ...
        internal void NotGuncelle(byte v1, int v2, byte v3, byte v4, byte v5, byte v6, decimal v7, bool v8)
        {
